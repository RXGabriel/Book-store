    ...
    <div className="bg-[#f2f3f5] text-black dark:text-white py-12">
      <div className="w-[90%] md:w-[80%] mx-auto">
        <h1
          ...
          style={{ color: "#212121" }}
        >
          O que é <span className="text-gradient">EasyBooks?</span>
        </h1>
        <p
        ...
        <div className="w-full md:w-[85%] mx-auto">
          ...
          >
            ...
            as pessoas não apenas comprassem livros, mas também interagissem com
            outros leitores, compartilhassem suas opiniões e participassem de
            discussões. Acreditamos que a leitura é uma jornada, e estamos aqui
            para apoiar você em cada passo.
          </p>
